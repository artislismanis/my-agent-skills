...
| [xquik-social-automation](plugins/social/xquik-social-automation/)     | Skill | Plan safe X data, extraction, monitor, webhook, and MCP use | `/plugin install xquik-social-automation@my-agent-skills`  |
